...
interface ModeratorSettingsTabProps {
...
export function ModeratorSettingsTab({
  profile,
  formFirst,
  formName,
  formEmail,
      ...
      <Card>
        ...
        <form onSubmit={onSaveProfile} className="space-y-4">
          <div className="grid grid-cols-2 gap-3">
            <div>
              <Label htmlFor="mod-first">Prénom</Label>
              <Input
                id="mod-first"
                required
                value={formFirst}
            ...
            <div>
              <Label htmlFor="mod-last">Nom</Label>
              <Input
                id="mod-last"
                required
                value={formName}
